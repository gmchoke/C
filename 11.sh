...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/gmchoke/C/master/nginx.conf" 
mkdir -p /home/vps/public_html 
echo "" > /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/gmchoke/C/master/vps.conf" 
